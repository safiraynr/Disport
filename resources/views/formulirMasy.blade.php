    ...
    <header class="masthead" style="background-image: url('img/gunung2.jpg')">
      <div class="container">
        <div class="intro-text">
          ...
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="/laporan">LAPOR LOKASI</a>
           <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="/bencana">REKAP LAPORAN</a>
        </div>
      </div>
    </header>
